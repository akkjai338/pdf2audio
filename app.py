...
async def generate_voice(text, output_file):
    communicate = edge_tts.Communicate(
        text,
        voice="en-IN-PrabhatNeural"  # Male Indian voice (Hinglish friendly)
    )
...
def convert():
    ...
    if text and text.strip() != "":
        ...
        return "Please enter text or upload PDF"
    ...
    asyncio.run(generate_voice(extracted_text, audio_path))
